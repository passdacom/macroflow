...
## Connections
- [[TestColorDisplayRows]] - `contains` [EXTRACTED]
- [[TestRelativeTime]] - `contains` [EXTRACTED]
- [[_build_rows 상대 시간 계산 단위 테스트.]] - `rationale_for` [EXTRACTED]
- [[_make_mouse_down()]] - `contains` [EXTRACTED]
