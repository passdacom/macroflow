...
- [[test_explicit_action_click_color_timeouts_override_legacy_value()]] - `calls` [EXTRACTED]
- [[test_legacy_single_click_color_timeout_loads_into_each_action()]] - `calls` [EXTRACTED]
- [[test_macro_file.py]] - `contains` [EXTRACTED]
- [[test_merge_macros_inserts_exact_gap_before_nonzero_first_timestamp()]] - `calls` [EXTRACTED]
...
- [[test_set_delay_all_can_target_only_displayed_primary_events()]] - `calls` [EXTRACTED]
