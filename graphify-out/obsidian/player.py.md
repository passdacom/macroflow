...
- [[_wait_for_click_color_check()]] - `contains` [EXTRACTED]
- [[_wait_for_color()]] - `contains` [EXTRACTED]
- [[_wait_for_color_check()]] - `contains` [EXTRACTED]
- [[_wait_for_window()]] - `contains` [EXTRACTED]
- [[get_current_event_idx()]] - `contains` [EXTRACTED]
- [[get_progress()]] - `contains` [EXTRACTED]
- [[is_playing()]] - `contains` [EXTRACTED]
