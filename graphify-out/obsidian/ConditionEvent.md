...
- [[Expression sandbox resource-safety regression tests.]] - `uses` [INFERRED]
...
- [[_condition()]] - `calls` [INFERRED]
- [[_dict_to_event()]] - `calls` [INFERRED]
- [[color_check_on_mismatch='wait'가 저장 후 동일하게 로드되어야 한다.]] - `uses` [INFERRED]
- [[condition 이벤트 — DSL 표현식 기반 조건 분기.      Attributes         expression 평가할 DSL 표]] - `rationale_for` [EXTRACTED]
