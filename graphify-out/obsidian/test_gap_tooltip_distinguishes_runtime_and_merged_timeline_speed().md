...
# test_gap_tooltip_distinguishes_runtime_and_merged_timeline_speed()

## Connections
- [[_ui_source()]] - `calls` [EXTRACTED]
- [[test_sequencer_backlog.py]] - `contains` [EXTRACTED]
- [[시퀀스 실제 대기와 병합 timestamp 간격의 speed 의미를 구분한다.]] - `rationale_for` [EXTRACTED]
