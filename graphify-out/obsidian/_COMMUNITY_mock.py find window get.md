...
```dataview
TABLE source_file, type FROM #community/mock.py_find_window_get
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_execute event PlayState player.py]]

## Top bridge nodes
- [[mock.py]] - degree 20, connects to 1 community